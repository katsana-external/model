...
[![tests](https://github.com/orchestral/model/workflows/tests/badge.svg?branch=8.x)](https://github.com/orchestral/model/actions?query=workflow%3Atests+branch%3A8.x)
...
[![Coverage Status](https://coveralls.io/repos/github/orchestral/model/badge.svg?branch=8.x)](https://coveralls.io/github/orchestral/model?branch=8.x)
